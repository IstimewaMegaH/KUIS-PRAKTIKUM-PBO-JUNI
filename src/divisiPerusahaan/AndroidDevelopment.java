 ...
 * @author istimewa
 */
public class AndroidDevelopment extends Divisi implements HitungNilaiAkhir{
    private double totalNilai;
    
    public AndroidDevelopment(String nik, String nama, int nilaiTulis, int nilaiCoding, int nilaiWawancara) {
